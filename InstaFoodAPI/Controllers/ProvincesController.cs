...
namespace InstaFoodAPI.Controllers
{
    ...
    public class ProvincesController : ControllerBase
    {
        ...
        public ProvincesController(InstaFoodDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Province>> PostProvince(Province province)
        {
            ...
            return CreatedAtAction("GetProvince", new { id = province.IdProv }, province);
        }
        ...
        {
            return _context.Provinces.Any(e => e.IdProv == id);
        }
    }
}
